...
{
	public partial class MyAppDB : Database
	{
		public MyAppDB() 
			: base(MyApp.Services.AppSettings.ConnectionString, "")
		{
			CommonConstruct();
		}

		//public MyAppDB(string connectionStringName) 
		...
		[ThreadStatic] static MyAppDB _instance;
		...
		{
			public static MyAppDB repo { get { return MyAppDB.GetInstance(); } }
